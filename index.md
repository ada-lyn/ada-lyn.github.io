...
The bias stayed pretty similar in terms of range (about 0.04) but not on the same months anymore. It may be due to a high correlation between the year and month and that correcting years biases changed the month biases. So at least we did not made the bias worse.
